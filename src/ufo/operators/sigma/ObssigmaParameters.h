...
/// Configuration options recognized by the sigma operator.
class ObssigmaParameters : public ObsOperatorParametersBase {
  OOPS_CONCRETE_PARAMETERS(ObssigmaParameters, ObsOperatorParametersBase)
