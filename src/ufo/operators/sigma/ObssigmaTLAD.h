...
// -----------------------------------------------------------------------------
/// sigma TL/AD observation operator class
class ObssigmaTLAD : public LinearObsOperatorBase {
 public:
  ...
  ObssigmaTLAD(const ioda::ObsSpace &, const Parameters_ &);
  virtual ~ObssigmaTLAD();
